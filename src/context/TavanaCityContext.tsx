...
export const INITIAL_ROOMS: CommunityRoom[] = [
  {
    id: 'room-guilds',
    title: 'اتاق جوامع اصناف (اکوسیستم آفرینا توانا سیتی)',
    description: 'هم‌اندیشی تشکل‌های صنفی، اتحادیه‌ها، اتاق اصناف و توسعه بازار کسب‌وکارهای دسترس‌پذیر در اکوسیستم توانا سیتی (TavanaCity)',
...
export const INITIAL_MESSAGES: ChatMessage[] = [
  {
    ...
    senderRole: 'ADMIN',
    text: 'به تالار رسمی اتاق جوامع اصناف در اکوسیستم آفرینا توانا سیتی (TavanaCity) خوش آمدید! در این فضا کلیه اتحادیه‌ها، صنوف و کارآفرینان دارای معلولیت می‌توانند همکاری‌های صنفی، تسهیلات و فرصت‌های تجاری متقابل را تبادل نمایند.',
